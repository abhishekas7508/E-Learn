...
<body style="background-image:url(images/login-bg.jpg);  background-size: cover; background-color:rgb(2,137,255)">
    <div class="d-flex container justify-content-center align-items-center">
        <div class="container bg-white main p-5 rounded shadow" style="width:400px; height:auto; margin-top:10%">
            ...
            <div class="d-flex align-items-center justify-content-between mb-2">
                ...
                <a href="http://localhost/online-courses/register.php">Register</a>
            </div>
            </form>
        </div>
    </div>
